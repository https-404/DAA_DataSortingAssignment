...
# Apply merge sort algorithm to sort the data based on the "Tax Liens" column in ascending order
merge_sort_ascending(data_list, "Tax Liens")
...
sorted_data.to_excel("SortedDataset_MergeSort_Ascending_TaxLiens.xlsx", index=False)
...
print(f"Execution time for Merge Sort (Ascending): {execution_time} seconds")
