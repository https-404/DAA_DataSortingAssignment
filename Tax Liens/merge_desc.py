...
# Apply merge sort algorithm to sort the data based on the "Tax Liens" column in descending order
merge_sort_descending(data_list, "Tax Liens")
...
sorted_data.to_excel("SortedDataset_MergeSort_Descending_TaxLiens.xlsx", index=False)
...
print(f"Execution time for Merge Sort (Descending): {execution_time} seconds")
