...
# Apply the insertion sort algorithm to sort the data based on the "Number of Credit Problems" column in descending order
insertion_sort_descending(data_list, "Number of Credit Problems")
...
sorted_data.to_excel("SortedDataset_InsertionSort_Descending_NumberOfCreditProblems.xlsx", index=False)
