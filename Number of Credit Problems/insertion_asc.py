...
# Apply the insertion sort algorithm to sort the data based on the "Number of Credit Problems" column in ascending order
insertion_sort(data_list, "Number of Credit Problems")
...
sorted_data.to_excel("SortedDataset_InsertionSort_Ascending_NumberOfCreditProblems.xlsx", index=False)
