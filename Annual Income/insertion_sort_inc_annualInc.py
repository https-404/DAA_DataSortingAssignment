...
# Apply the insertion sort algorithm to the "Annual Income" column in ascending order
insertion_sort(annual_income_column, ascending=True)
...
sorted_data = data
sorted_data.to_excel("SortedDataset_InsertionSort_Ascending.xlsx", index=False)
