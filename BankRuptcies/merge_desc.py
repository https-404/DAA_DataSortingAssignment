...
# Apply merge sort algorithm to sort the data based on the "Bankruptcies" column in descending order
merge_sort_descending(data_list, "Bankruptcies")
...
sorted_data.to_excel("SortedDataset_MergeSort_Descending_Bankruptcies.xlsx", index=False)
