...
# Apply the merge sort algorithm to sort the data based on the "Months since last delinquent" column
merge_sort(data_list, "Months since last delinquent")
...
sorted_data.to_excel("SortedDataset_MergeSort_MonthsSinceLastDelinquent.xlsx", index=False)
