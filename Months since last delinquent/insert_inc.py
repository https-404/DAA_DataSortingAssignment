...
# Apply insertion sort to sort the data based on the "Months since last delinquent" column in ascending order
insertion_sort(data_list, "Months since last delinquent")
...
sorted_data.to_excel("SortedDataset_InsertionSort_Ascending_MonthsSinceLastDelinquent.xlsx", index=False)
