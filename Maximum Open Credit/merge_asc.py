...
# Merge sort implementation for ascending order with NaN handling
...
# Apply merge sort in ascending order with NaN handling to sort the data based on the "Maximum Open Credit" column
merge_sort_ascending(data_list, "Maximum Open Credit")
...
sorted_data.to_excel("SortedDataset_MergeSort_Ascending_MaximumOpenCredit.xlsx", index=False)
