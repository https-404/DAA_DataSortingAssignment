...
# Apply the insertion sort algorithm to sort the data based on the "Number of Open Accounts" column in descending order
insertion_sort_descending(data_list, "Number of Open Accounts")
...
sorted_data.to_excel("SortedDataset_InsertionSort_Descending_NumberOfOpenAccounts.xlsx", index=False)
