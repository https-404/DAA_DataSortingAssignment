...
# Apply the merge sort algorithm to sort the data based on the "Current Credit Balance" column in descending order
merge_sort_descending(data_list, "Current Credit Balance")
...
sorted_data.to_excel("SortedDataset_MergeSort_Descending_CurrentCreditBalance.xlsx", index=False)
