...
# Apply the merge sort algorithm to sort the data based on the "Years of Credit History" column
merge_sort(data_list, "Years of Credit History")
...
sorted_data.to_excel("SortedDataset_MergeSort_YearsOfCreditHistory.xlsx", index=False)
