...
# Apply the insertion sort algorithm to sort the data based on the "Years of Credit History" column in ascending order
insertion_sort(data_list, "Years of Credit History")
...
sorted_data.to_excel("SortedDataset_InsertionSort_YearsOfCreditHistory.xlsx", index=False)
